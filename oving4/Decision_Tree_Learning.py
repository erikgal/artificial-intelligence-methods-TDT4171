...
if __name__ == '__main__':
    ...
    dict = {}
    attributes = ['Pclass', 'Sex', 'Embarked'] #['Pclass', 'Sex', 'SibSp', 'Parch', 'Embarked']
    ...
    dict = {}
    attributes = ['Pclass', 'Sex', 'Embarked', 'Fare', 'Parch', 'SibSp'] #['Pclass', 'Sex', 'SibSp', 'Parch', 'Embarked', 'Fare']
    result = DTL(titanic_train, attributes, None, 'Survived', graph)
    decision_dict = result[1]
    graph.view()
